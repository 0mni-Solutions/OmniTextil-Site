...
function dht11(options) {
    ...
    if (minTemperature < 0 || maxTemperature > 60) {
      throw new Error(
        "Os valores minímos e máximos para temperatura são 0 e 50 respectivamente."
      );
    }
  
    minTemperature = typeof minTemperature == "undefined" ? 20 : minTemperature;
    maxTemperature = typeof maxTemperature == "undefined" ? 80 : maxTemperature;
