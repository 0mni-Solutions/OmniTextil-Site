...
router.post('/sendData', (request, response) => {
     ...
     */
    var sql = "INSERT INTO dados(fkSensor,temperatura,umidade) VALUES(?)"; 
    let values = [1,temperatura,umidade];

    // acquatec
    // var sql = "INSERT INTO medida(dht11_umidade,dht11_temperatura,fk_aquario) VALUES(?)"; 
    // let values = [umidade,temperatura,1];
